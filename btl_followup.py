"""
BTL follow-up conversation logic.
Renamed btl_followup.py to avoid collision with RSS scorer's potential followup utilities.
"""
...
def build_context_header(claim: str, result: dict) -> str:
    """Build context string from original claim and BTL assessment."""
